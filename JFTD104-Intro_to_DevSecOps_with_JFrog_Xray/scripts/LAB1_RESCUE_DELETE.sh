...
jf xr curl -XDELETE /api/v1/binMgr/1/repos -H "Content-Type: application/json" -d @index-repos.json
jf xr curl -XDELETE /api/v1/binMgr/1/builds -H "Content-Type: application/json" -d @index-builds.json
